...
const foodData = [
  ...
  const vegetables = foodData.filter(item => item.category === "Vegetable");
  ...
  const proteins = foodData.filter(item => item.category === "Protein");
  ...
  const above100Calories = foodData.filter(item => item.calorie > 100);
  console.log("Calorie Above 100:", above100Calories);
  
  // Task 9: List all the food items with calorie below 100
  const below100Calories = foodData.filter(item => item.calorie < 100);
  console.log("Calorie Below 100:", below100Calories);
  
  // Task 10: List all the food items with highest protein content to lowest
  const sortedByProtein = foodData.slice().sort((a, b) => b.protiens - a.protiens);
  console.log("Highest Protein to Lowest:", sortedByProtein);
  
  // Task 11: List all the food items with lowest carb content to highest
  const sortedByCarb = foodData.slice().sort((a, b) => a.cab - b.cab);
  console.log("Lowest Carb to Highest:", sortedByCarb);
